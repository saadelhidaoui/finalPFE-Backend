...
public class ExcelHelperAdherent {
    ...
    static String[] HEADERs = {"numAdhesion", "cin", "nom", "prenom", "origine", "ville", "telephone", "qualite", "adresse", "ppr", "dtNaissance", "etatCarte", "dtArrivee", "dtReception", "statut", "fonction", "username"};
                ...
                while (cellsInRow.hasNext()) {
                    ...
                    switch (cellIdx) {
                        ...
                        case 5:
                            ...
                            Ville ville = villeAdminService.findByReference(s5);
                        ...
                        case 7:
                            ...
                            Qualite qualite = qualiteAdminService.findByReference(s7);
                        ...
                        case 11:
                            ...
                            EtatCarte etatCarte = etatCarteAdminSerice.findByReference(s11);
