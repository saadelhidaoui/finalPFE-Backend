...
@Service
public class PieceJointeProjetModerateurServiceImpl extends AbstractServiceImpl<PieceJointeProjet> implements PieceJointeProjetModerateurService {
    ...
    @Autowired
    private ProjetModerateurService projetService;
