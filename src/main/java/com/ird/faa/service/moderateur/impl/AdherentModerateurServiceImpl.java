...
import com.ird.faa.service.moderateur.facade.AdherentModerateurService;
        import com.ird.faa.service.moderateur.facade.StatutModerateurService;
        import com.ird.faa.service.moderateur.facade.QualiteModerateurService;
        import com.ird.faa.service.moderateur.facade.EtatCarteModerateurService;
        import com.ird.faa.service.moderateur.facade.FonctionModerateurService;
        import com.ird.faa.service.moderateur.facade.EnfantModerateurService;
        import com.ird.faa.service.moderateur.facade.ConjointModerateurService;
...
@Service
public class AdherentModerateurServiceImpl extends AbstractServiceImpl<Adherent> implements AdherentModerateurService {
...
private AdherentDao adherentDao;
    ...
    private ArchivableService<Adherent> archivableService;
        @Autowired
        private StatutModerateurService statutService ;
        @Autowired
        private QualiteModerateurService qualiteService ;
        @Autowired
        private EtatCarteModerateurService etatCarteService ;
        @Autowired
        private FonctionModerateurService fonctionService ;
        @Autowired
        private EnfantModerateurService enfantService ;
        @Autowired
        private ConjointModerateurService conjointService ;
        @Autowired
        private VilleModerateurService villeService ;
        @Autowired
        private PieceJointeAdherentModerateurService pieceJointeAdherentService ;
...
public Adherent findByIdWithAssociatedList(Long id){
    ...
    @Override
    public Adherent archiver(Adherent adherent) {
    if (adherent.getArchive() == null) {
    adherent.setArchive(false);
    }
    adherent.setArchive(true);
    adherent.setDateArchivage(new Date());
    ...
    @Override
    public Adherent desarchiver(Adherent adherent) {
    if (adherent.getArchive() == null) {
    adherent.setArchive(false);
    }
    adherent.setArchive(false);
    adherent.setDateArchivage(null);
    adherentDao.save(adherent);
    return adherent;
    }
