...
import com.ird.faa.service.moderateur.facade.*;
...
public class ModerateurModerateurServiceImpl extends AbstractServiceImpl<Moderateur> implements ModerateurModerateurService {
    ...
    @Override
    public int save2(ModerateurVo moderateurVo) throws ParseException {
        Moderateur moderateur = new Moderateur();
        moderateur.setNom(moderateurVo.getNom());
        moderateur.setPrenom(moderateurVo.getPrenom());
        moderateur.setNumeroMatricule(moderateurVo.getNumeroMatricule());
        moderateur.setPassword(bCryptPasswordEncoder.encode(moderateurVo.getPassword()));
        moderateur.setEmail(moderateurVo.getUsername());
