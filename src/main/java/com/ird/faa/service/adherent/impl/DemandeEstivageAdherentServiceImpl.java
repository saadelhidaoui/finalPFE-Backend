...
@Service
public class DemandeEstivageAdherentServiceImpl extends AbstractServiceImpl<DemandeEstivage> implements DemandeEstivageAdherentService {
    ...
    @Autowired
    private EtatDemandeEstivageAdherentService etatDemandeEstivageService;
    @Autowired
    private PieceJointeEstivageAdherentService pieceJointeEstivageService;
    @Autowired
    private DemandeEstivageCentreAdherentService demandeEstivageCentreService;
    @Autowired
    ...
    @Override
    public List<DemandeEstivage> findByAdherentUsername2(String username2) {
        return demandeEstivageDao.findByAdherentEmail(username2);
    }
    ...
    public DemandeEstivage save(DemandeEstivage demandeEstivage) {
        ...
        EtatDemandeEstivage etatDemandeEstivage = etatDemandeEstivageService.findByLibelle("En cours");
        demandeEstivage.setEtatDemandeEstivage(etatDemandeEstivage);

        savePieceJointeEstivages(savedDemandeEstivage, demandeEstivage.getPieceJointeEstivages());
        DemandeEstivage result = savedDemandeEstivage;
