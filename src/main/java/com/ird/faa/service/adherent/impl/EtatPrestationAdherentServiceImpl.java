...
import com.ird.faa.service.adherent.facade.EtatPrestationAdherentService;
...
@Service
public class EtatPrestationAdherentServiceImpl extends AbstractServiceImpl<EtatPrestation> implements EtatPrestationAdherentService {
...
public List<EtatPrestation> findAll(){
    ...
    @Override
    public EtatPrestation findByLibelle(String libelle) {
        return etatPrestationDao.findByLibelle(libelle);
    }
