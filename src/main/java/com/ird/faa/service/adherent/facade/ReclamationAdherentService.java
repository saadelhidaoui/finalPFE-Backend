...
public interface ReclamationAdherentService extends AbstractService<Reclamation,Long,ReclamationVo>{
...
/**
    ...
    */
    ...
    Reclamation archiver(Reclamation reclamation) ;
    Reclamation desarchiver(Reclamation reclamation);
