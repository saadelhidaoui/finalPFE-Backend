...
@Service
public class PieceJointeAdherentAdminServiceImpl extends AbstractServiceImpl<PieceJointeAdherent> implements PieceJointeAdherentAdminService {
    ...
    @Override
    public PieceJointeAdherent getFile(Long id) {
        return pieceJointeAdherentDao.findById(id).get();
    }
