...
import com.ird.faa.service.admin.facade.EtatProjetAdminService;
...
@Service
public class ProjetAdminServiceImpl extends AbstractServiceImpl<Projet> implements ProjetAdminService {
    ...
    @Autowired
    private EtatProjetAdminService etatProjetService;
