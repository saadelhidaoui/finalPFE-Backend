...
@Service
public class PrestationAdminServiceImpl extends AbstractServiceImpl<Prestation> implements PrestationAdminService {
    ...
    @Autowired
    private EtatPrestationAdminService etatPrestationService;
    @Autowired
    private PieceJointePrestationAdminService pieceJointePrestationService;
    @Autowired
    private NiveauImportanceAdminService niveauImportanceService;
    @Autowired
    ...
    public List<Prestation> findByCriteria(PrestationVo prestationVo) {
        ...
        query += SearchUtil.addConstraint("o", "nom", "LIKE", prestationVo.getNom());
        query += SearchUtil.addConstraint("o", "prenom", "LIKE", prestationVo.getPrenom());
        query += SearchUtil.addConstraint("o", "origine", "LIKE", prestationVo.getOrigine());
