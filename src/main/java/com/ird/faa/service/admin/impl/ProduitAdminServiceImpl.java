...
import com.ird.faa.service.admin.facade.PieceJointeProduitAdminService;
...
public class ProduitAdminServiceImpl extends AbstractServiceImpl<Produit> implements ProduitAdminService {
    ...
    @Autowired
    private PieceJointeProduitAdminService pieceJointeProduitService;
    ...
    @Override
    public Produit addQuantite(Produit produit) {
        Long res = produit.getQuantite();
        produit.setQuantite(res);
        produitDao.save(produit);
        return produit ;
    }

    @Override
    public Produit substractQuantite(Produit produit) {
