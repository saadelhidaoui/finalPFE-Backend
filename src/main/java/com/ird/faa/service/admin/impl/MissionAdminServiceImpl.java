...
import com.ird.faa.service.admin.facade.ModerateurAdminService;
...
@Service
public class MissionAdminServiceImpl extends AbstractServiceImpl<Mission> implements MissionAdminService {
    ...
    @Autowired
    private ModerateurAdminService moderateurService;
    @Autowired
    private PieceJointeMissionAdminService pieceJointeMissionService;
    ...
    public Mission save(Mission mission) {
        ...
        Mission result = null;
        Mission foundedMission = missionDao.findByReference(mission.getReference());
