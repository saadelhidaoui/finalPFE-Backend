...
@Service
public class DemandeEstivageCentreAdminServiceImpl extends AbstractServiceImpl<DemandeEstivageCentre> implements DemandeEstivageCentreAdminService {

    @Autowired
    private DemandeEstivageCentreDao demandeEstivageCentreDao;

    @Autowired
    private DemandeEstivageAdminService demandeEstivageService;
    @Autowired
