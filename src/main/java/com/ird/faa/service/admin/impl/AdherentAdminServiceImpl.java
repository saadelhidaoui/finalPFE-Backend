...
@Service
public class AdherentAdminServiceImpl extends AbstractServiceImpl<Adherent> implements AdherentAdminService {
    ...
    @Autowired
    private EtatCarteAdminService etatCarteService;
    @Autowired
    private FonctionAdminService fonctionService;
    @Autowired
    private EnfantAdminService enfantService;
    @Autowired
    private ConjointAdminService conjointService;
    @Autowired
