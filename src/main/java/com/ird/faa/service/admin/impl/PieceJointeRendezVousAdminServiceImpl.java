...
import com.ird.faa.service.admin.facade.RendezVousAdminService;
...
@Service
public class PieceJointeRendezVousAdminServiceImpl extends AbstractServiceImpl<PieceJointeRendezVous> implements PieceJointeRendezVousAdminService {
    ...
    public void uploadFile(MultipartFile file, String reference) throws IOException {
        PieceJointeRendezVous pieceJointeRendezVous = new PieceJointeRendezVous();
        String path = System.getProperty("user.home") + "\\rv-pieces-jointes\\";
        File path1 = new File(System.getProperty("user.home") + "\\rv-pieces-jointes\\" + file.getOriginalFilename());
...
//        demandePieceJointe.setType(file.getContentType());
        ...
        rendezVous.setPieceJointeRendezVouss(ds);
    ...
    @Override
    public PieceJointeRendezVous getFile(Long id) {
        return pieceJointeRendezVousDao.findById(id).get();
    }
