...
@RestController
@RequestMapping("api/moderateur/pieceJointeAdherent")
public class PieceJointeAdherentRestModerateur {
    ...
    public ResponseEntity<byte[]> getFile(@PathVariable Long id) {
        PieceJointeAdherent pieceJointeAdherent = pieceJointeAdherentService.getFile(id);
