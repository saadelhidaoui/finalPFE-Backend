...
public class ProjetRestAdmin {
    ...
    @PutMapping("/archiver/")
    public ProjetVo archiver(@RequestBody ProjetVo projetVo) {
        Projet projet = projetService.archiver(projetConverter.toItem(projetVo));
        return projetConverter.toVo(projet);
    }

    @PutMapping("/desarchiver/")
    public ProjetVo desarchiver(@RequestBody ProjetVo projetVo) {
        Projet projet = projetService.desarchiver(projetConverter.toItem(projetVo));
        return projetConverter.toVo(projet);
    }
}
