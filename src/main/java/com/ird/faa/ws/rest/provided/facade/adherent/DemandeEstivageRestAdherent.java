...
import com.ird.faa.service.adherent.facade.DemandeEstivageAdherentService;
...
@RestController
@RequestMapping("api/adherent/demandeEstivage")
public class DemandeEstivageRestAdherent {

    @Autowired
    private DemandeEstivageAdherentService demandeEstivageService;
    ...
    public List<DemandeEstivageVo> findByAdherentUsername2(@PathVariable String username2) {
        return demandeEstivageConverter.toVo(demandeEstivageService.findByAdherentUsername2(username2));
    }
}
