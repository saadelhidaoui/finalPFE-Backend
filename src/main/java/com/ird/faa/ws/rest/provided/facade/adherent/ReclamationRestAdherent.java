...
public class ReclamationRestAdherent {
    ...
    public List<ReclamationVo> findByAdherentUsername2(@PathVariable String username2) {
        return reclamationConverter.toVo(reclamationService.findByAdherentUsername2(username2));
    }
